...
export const sitePages = {
  grocery: {
    page_title: 'Grocery - El Gallo Market',
  ...
  makeup: {
    page_title: 'Makeup - El Gallo Market',
  ...
  bags: {
    page_title: 'Bags - El Gallo Market',
  ...
  clothing: {
    page_title: 'Clothing - El Gallo Market',
  ...
  furniture: {
    page_title: 'Furniture - El Gallo Market',
  ...
  book: {
    page_title: 'Book - El Gallo Market',
  ...
  medicine: {
    page_title: 'Medicine - El Gallo Market',
